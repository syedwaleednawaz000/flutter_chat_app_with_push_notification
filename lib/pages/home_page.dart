                ...
                children: [
                  ...
                  Expanded(
                    child: StreamBuilder<QuerySnapshot>(
                      stream: homeProvider.getStreamFireStore(FirestoreConstants.pathUserCollection, _limit, searchBarTec.text),
                          ...
                          if ((snapshot.data?.docs.length ?? 0) > 0) {
                            return ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                // print("this is our data lenght ${snapshot.data.docs.length}");
